...
const NewBlog = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
        <h1 className='md:text-4x1 text-2xl font-semibold'>Subscribe to Next Blog!</h1>
        <p className='md:text-lg text-gray-500/70 pb-8'>Latest blogs, tech,and exclusive content.</p>
